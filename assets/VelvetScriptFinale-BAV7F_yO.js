...
`;function R(e,t,n){let r=new o({vertexShader:e,fragmentShader:t,uniforms:{uForm:{value:0},uTime:{value:0},uPx:{value:800},uAlpha:{value:0},uChurn:{value:0},...n},transparent:!0,depthWrite:!1,blending:5});return r.blendEquation=100,r.blendSrc=204,r.blendDst=201,r.blendEquationAlpha=100,r.blendSrcAlpha=200,r.blendDstAlpha=201,r}function z({progress:e,density:t,config:n}){let{viewport:r,size:a}=u(),o=O(n.font.loadSpec),s=(0,p.useRef)(null),c=(0,p.useRef)(null),l=Math.max(200,Math.round(n.heroCount*(t??1))),d=Math.max(500,Math.round(n.fieldCount*(t??1))),f=(0,p.useMemo)(()=>T(r.width,r.height,n.font,o,l,d),[r.width,r.height,o,l,d]),m=n.glowRange??[.75,1.2],h=(0,p.useMemo)(()=>f?k(d,{aWord:{array:f.fieldWord,itemSize:3},aScatter:{array:f.fieldScatter,itemSize:3},aAsh:{array:f.fieldAsh,itemSize:3},aLine:{array:f.fieldLine,itemSize:3},aColor:{array:w(d,n.palette,...m),itemSize:3},aSize:{array:C(d,...n.fieldSize),itemSize:1},aSeed:{array:C(d,0,100),itemSize:1},aRow:{array:f.fieldRow,itemSize:1},aMember:{array:f.fieldMember,itemSize:1}}):null,[f,d]),g=(0,p.useMemo)(()=>f?k(l,{aN:{array:f.heroN,itemSize:3},aS:{array:f.heroS,itemSize:3},aScatter:{array:f.heroScatter,itemSize:3},aColor:{array:w(l,n.palette,...m),itemSize:3},aSize:{array:C(l,...n.heroSize),itemSize:1},aSeed:{array:C(l,0,100),itemSize:1},aRow:{array:f.heroRow,itemSize:1}}):null,[f,l]),y=(0,p.useMemo)(()=>R(n.fieldVertex,n.fragment,{uAsh:{value:0},uLine:{value:0}}),[]),b=(0,p.useMemo)(()=>R(n.heroVertex,n.fragment,{uMorph:{value:0},uLine:{value:0}}),[]);return(0,p.useEffect)(()=>()=>{h?.dispose(),g?.dispose()},[h,g]),(0,p.useEffect)(()=>()=>{y.dispose(),b.dispose()},[y,b]),i(t=>{if(!f)return;let n=t.clock.elapsedTime,r=_(e.get()),i=v(r),o=A(a.height),l=s.current?.material;l&&(l.uniforms.uTime.value=n,l.uniforms.uPx.value=o,l.uniforms.uAlpha.value=r.appear,l.uniforms.uForm.value=r.form,l.uniforms.uAsh.value=r.ash,l.uniforms.uLine.value=r.line,l.uniforms.uChurn.value=i);let u=c.current?.material;u&&(u.uniforms.uTime.value=n,u.uniforms.uPx.value=o,u.uniforms.uAlpha.value=r.appear,u.uniforms.uForm.value=r.form,u.uniforms.uMorph.value=r.morph,u.uniforms.uLine.value=r.line,u.uniforms.uChurn.value=i)}),!f||!h||!g?null:(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`points`,{ref:s,geometry:h,material:y,frustumCulled:!1}),(0,j.jsx)(M,{targets:f,progress:e,children:(0,j.jsx)(`points`,{ref:c,geometry:g,material:b,frustumCulled:!1})}),n.extras?.(f,e)]})}function B(e){return function({progress:t,density:n}){return(0,j.jsx)(d,{camera:{position:[0,0,10],fov:50,near:.1,far:60},dpr:[1,1.5],gl:{alpha:!0,antialias:!1,powerPreference:`high-performance`},style:{pointerEvents:`none`},children:(0,j.jsx)(z,{progress:t,density:n,config:e})})}}var V=`
